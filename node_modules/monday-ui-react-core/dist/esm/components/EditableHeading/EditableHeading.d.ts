...
declare const _default: ((VibeComponent<EditableHeadingProps & React.RefAttributes<HTMLElement>, HTMLElement> & Partial<{
    types: typeof HeadingType;
    weights: typeof HeadingWeight;
}>) | (React.FC<EditableHeadingProps & React.RefAttributes<HTMLElement>> & Partial<{
    types: typeof HeadingType;
    weights: typeof HeadingWeight;
}>)) & {
    types: typeof HeadingType;
